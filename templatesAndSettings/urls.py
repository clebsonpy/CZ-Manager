...
urlpatterns = [re_path(r'^' + '', admin.site.urls),
               ...
               re_path(r'odm2admin/' + 'AddSensor', views.AddSensor, name="AddSensor"),
               re_path(r'odm2admin/' + 'chartIndex', views.chartIndex,
                   name="chartIndex"),
               re_path(r'odm2admin/' + 'AddProfile', views.AddProfile,
                   name="AddProfile"),
               re_path(r'odm2admin/' + 'RecordAction', views.RecordAction,
                   name="RecordAction"),
               re_path(r'odm2admin/' + 'ManageCitations', views.ManageCitations,
                   name="ManageCitations"),
               re_path(r'odm2admin/' + 'chart', views.TimeSeriesGraphing,
                   name="TimeSeriesGraphing"),
               re_path(r'odm2admin/' + 'mapdata', views.web_map, name="WebMap"),
               ...
               re_path(r'odm2admin/' + 'sensordashboard/featureaction=(?P<feature_action>(\d+))/', views.sensor_dashboard),
               re_path(r'odm2admin/' + 'sensordashboard/samplingfeature=(?P<sampling_feature>(\d+))/', views.sensor_dashboard),
               re_path(r'odm2admin/' + 'sensordashboard/$', views.sensor_dashboard),
               ...
               re_path(r'^' + 'chartVariableAndFeature.html', views.graph_data,
                   name="graph_data"),
               re_path(r'odm2admin/' + 'soilsscatterplot.html', views.scatter_plot,
                   name="scatter_plot"),
               re_path(r'odm2admin/' + 'publications.html', views.publications,
                   name="publications"),
